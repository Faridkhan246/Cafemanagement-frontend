...
export class ManageOrderComponent implements OnInit {
  ...
  displayedColumns: string[] = ['name', 'categegory', 'price', 'quantity', 'total', 'edit'];
  dataSource: any = [];
  ...
  setQuantity() {
    ...
    if (temp > 0) {
      ...
      this.manageOrderForm.controls['quantity'].setVlaue('1');
  ...
  submitAction() {
    ...
    var data = {
      ...
      productDetials: JSON.stringify(this.dataSource)
    }
